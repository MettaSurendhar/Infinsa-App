        ...
        body: SafeArea(
          ...
          child: StreamBuilder<List<AccountsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<AccountsRecord> listViewAccountsRecordList = snapshot.data!;
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 7.0),
                                    child: Text(
                                      listViewAccountsRecord.accountType,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                                            fontFamily: 'Readex Pro',
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      listViewAccountsRecord.accountNumber
                                          .toString(),
                                      'xxx-xxx',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      listViewAccountsRecord.balance.toString(),
                                      '0.00',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .headlineMedium
