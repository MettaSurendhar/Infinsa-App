...
class _LoanWidgetState extends State<LoanWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoanModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: ListView(
            ...
            children: [
              wrapWithModel(
                model: _model.carloanModel,
                updateCallback: () => safeSetState(() {}),
                child: const CarloanWidget(),
              ),
              wrapWithModel(
                model: _model.homeloanModel,
                updateCallback: () => safeSetState(() {}),
                child: const HomeloanWidget(),
              ),
            ],
          ),
        ),
