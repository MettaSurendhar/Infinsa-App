...
import 'create_expense_tracking_model.dart';
export 'create_expense_tracking_model.dart';

class CreateExpenseTrackingWidget extends StatefulWidget {
  const CreateExpenseTrackingWidget({super.key});

  @override
  State<CreateExpenseTrackingWidget> createState() =>
      _CreateExpenseTrackingWidgetState();
}

class _CreateExpenseTrackingWidgetState
    extends State<CreateExpenseTrackingWidget> {
  late CreateExpenseTrackingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateExpenseTrackingModel());
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'Expense amount(in rupees)',
                    labelStyle:
                        FlutterFlowTheme.of(context).labelMedium.override(
                              fontFamily: 'Plus Jakarta Sans',
                              color: const Color(0xFF57636C),
